let app_show=document.querySelector(".app5_show");
let previos_btn=document.getElementById("previos_btn");
let Next_btn=document.getElementById("Next_btn");

let element_container=[];

element_container[0]="imges/t-shirt2.jpg";
element_container[1]="imges/t-shirt3.jpg";
element_container[2]="imges/t-shirt4.jpg";
element_container[3]="imges/t-shirt5.jpg";
element_container[4]="imges/t-shirt6.jpg";
...
let action=document.querySelector(".app5_show");
console.log(action);
