let app_show=document.querySelector(".app2_show");
let previos_btn=document.getElementById("previos_btn");
let Next_btn=document.getElementById("Next_btn");

let element_container=[];

element_container[0]="imges/img34.jpg";
element_container[1]="imges/img35.jpg";
element_container[2]="imges/img36.jpg";
element_container[3]="imges/img37.jpg";
element_container[4]="imges/img38.jpg";
element_container[5]="imges/img40.jpg";
...
let action=document.querySelector(".app2_show");
console.log(action);
