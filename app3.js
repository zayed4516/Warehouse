let app_show=document.querySelector(".app3_show");
let previos_btn=document.getElementById("previos_btn");
let Next_btn=document.getElementById("Next_btn");

let element_container=[];

element_container[0]="imges/img52.jpg";
element_container[1]="imges/img53.jpg";
element_container[2]="imges/img54.jpg";
element_container[3]="imges/img55.jpg";
element_container[4]="imges/img56.jpg";
...
let action=document.querySelector(".app3_show");
console.log(action);
